...
INVALID
```
Test out your program with a whole bunch of inputs, both valid and invalid. [Here](https://developer.paypal.com/api/nvp-soap/payflow/integration-guide/test-transactions/#standard-test-cards) are a few card numbers that PayPal recommends for testing.
